...
function buildURI() {
    ...
    console.log(token);
    if (token) {
        return "${modules_host}/client-api/feed?size=16&auth_provider=google&auth_type=access_token&auth_token=" + token + "&page="
    }
    return "${modules_host}/client-api/feed?size=16&page="
}
        ...
        return (
            <div className="card blue-grey darken-1">
                ...
                <div className="card-action">
                    <a href={this.props.url}>Read more on {this.props.sourceName}...</a>
                </div>
            </div>
        );
    }
        ...
        for (var i = 0; i < this.props.data.length; i++) {
            ...
            nodes.push(
                <div className={class_name}>
                    <DiploPanel title={data_elem.title} url={data_elem.url} sourceName={data_elem.sourceName}/>
                </div>
            )
        }
