<%@ page import="com.github.dipodoc.diploweb.domain.diploexec.Module; com.github.dipodoc.diploweb.domain.diploexec.ModuleMethod" %>
...
<div class="fieldcontain ${hasErrors(bean: moduleMethodInstance, field: 'module', 'error')} required">
	...
	<g:select id="module" name="module.id" from="${Module.list()}" optionKey="id" optionValue="name" readonly="true" required="" value="${moduleMethodInstance?.module?.id}" class="many-to-one"/>
</div>
